#ifndef _ZLIGHT_LIBBYZ_H
#define _ZLIGHT_LIBBYZ_H
...
int zlight_init_replica(char *conf, char *conf_priv, char *host_name, int(*exec)(Byz_req*, Byz_rep*, Byz_buffer*,
