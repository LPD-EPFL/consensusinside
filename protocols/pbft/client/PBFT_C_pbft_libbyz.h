#ifndef _PBFT_C_PBFT_LIBBYZ_H
#define _PBFT_C_PBFT_LIBBYZ_H
...
/* Requires: "req" points to a Byz_req structure
   ...
   contain the number of bytes that can be used starting from "req->contents". If it PBFT_C_fails
   it returns -1. */
...
void PBFT_C_pbft_reset_PBFT_C_stats();
/* Effects: Resets library's statistics counters */

void PBFT_C_pbft_print_PBFT_C_stats();
