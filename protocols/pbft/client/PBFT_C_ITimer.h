#ifndef _PBFT_C_ITimer_h
#define _PBFT_C_ITimer_h 1
...
public:
  ...
  // Effects: Calls handlers for PBFT_C_ITimer instances that have expired.
#else
  inline static void handle_timeouts() {
    PBFT_C_Time current = PBFT_C_rdtsc();
...
private:
  ...
  PBFT_C_Time deadline;
  PBFT_C_Time period;

#ifndef USE_GETTIMEOFDAY
  // Use cycle counter
  static PBFT_C_Time min_deadline;
  static void _handle_timeouts(PBFT_C_Time current);
#endif // USE_GETTIMEOFDAY

  static Array<PBFT_C_ITimer*> timers;
};

#endif // _PBFT_C_ITimer_h
