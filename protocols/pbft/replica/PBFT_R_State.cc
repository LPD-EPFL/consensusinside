...
#ifndef NO_STATE_TRANSLATION
PBFT_R_State::PBFT_R_State(PBFT_R_Replica *rep, int num_objs,
	     int (*gets)(int, char **),
	     void (*puts)(int, int *, int *, char **),
	     void (*shutdown_p)(FILE *o),
	     void (*restart_p)(FILE *i)) : 
  PBFT_R_replica(rep), nb(num_objs+PBFT_R_replica->used_state_pages()), 
...
#ifndef NO_STATE_TRANSLATION
char* PBFT_R_State::get_cached_obj(int i) {
