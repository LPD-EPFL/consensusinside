#ifndef _PBFT_R_Req_queue_h
#define _PBFT_R_Req_queue_h
...
inline int PBFT_R_Req_queue::size() const
{
	return nelems;
}

inline int PBFT_R_Req_queue::num_bytes() const
{
	return nbytes;
}

inline PBFT_R_Request *PBFT_R_Req_queue::first() const
{
	if (head)
	{
...
inline PBFT_R_Request *PBFT_R_Req_queue::first_client(int cid) const
{
	PPBFT_R_Node& cn = reqs[cid];
	return cn.r;
}

inline bool PBFT_R_Req_queue::in_progress(int cid, Request_id rid, View v)
{
	PPBFT_R_Node& cn = reqs[cid];
