#ifndef _QUORUM_LIBBYZ_H
#define _QUORUM_LIBBYZ_H
...
int quorum_init_replica(char *conf, char *conf_priv, char *host_name, int(*exec)(Byz_req*, Byz_rep*, Byz_buffer*,
