#ifndef _MULTIPAXOS_LIBBYZ_H
#define _MULTIPAXOS_LIBBYZ_H
...
int multipaxos_init_replica(char *conf, char *conf_priv, char *host_name, int(*exec)(Byz_req*, Byz_rep*, Byz_buffer*,
